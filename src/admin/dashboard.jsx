    ...
    <div className="min-h-screen bg-gray-100 p-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg animate__fadeIn">
          <h2 className="text-2xl font-semibold text-sky-600 mb-4">Upload Cars For Rent</h2>
          <UploadCars />
        </div>
        
        {/* Fetch Cars Section */}
        <div className="bg-white p-6 rounded-lg shadow-lg animate__fadeIn">
          <h2 className="text-2xl font-semibold text-sky-600 mb-4">Cars Currently Available</h2>
          <FetchCars />
        </div>
      </div>
    </div>
